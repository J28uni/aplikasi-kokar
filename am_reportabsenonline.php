...
<head>
  ...
  <link rel="stylesheet" href="css/bootstrap.min.css">
    ...
    <script src="assets/datepicker/dist/js/bootstrap-datepicker.min.js"></script>
    <script src="https://cdn.jsdelivr.net/npm/chart.js@2.8.0"></script>
    <link rel="stylesheet" type="text/css" href="assets/datepicker/dist/css/bootstrap-datepicker.min.css">
    <!-- <link rel="stylesheet" type="text/css" href="assets/datepicker/dist/css/bootstrap-datepicker3.min.css"> -->
...
<body>
  ...
  <nav class="navbar navbar-expand-md navbar-light bg-success fixed-top">
    ...
    <div class="collapse navbar-collapse" id="navbarToggler">
      <a class="navbar-brand nav-link" href="am_home.php"><img src="img/home.svg" height="30px" width="30"></a>
      <ul class="navbar-nav mr-auto mt-2 mt-md-0">
        <li class="nav-item">
          <a class="nav-link active bg-light" href="am_reportabsenonline.php">Report Absensi</a>
        </li>
        <li class="nav-item">
  ...
  <?php
  require_once "pages/am_reportabsen.php";
  ?>
